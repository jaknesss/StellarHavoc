...
public class MeshDestroy : MonoBehaviour {
    public float timerAmountToReduce;
    public bool contributesTimer;
    ...
    public void DestroyMesh() {
        ...
        if(contributesTimer) FindObjectOfType<TimerController>().ReduceTimer(timerAmountToReduce);
    ...
    public class PartMesh {
        ...
        public void MakeGameobject(MeshDestroy original) {
            ...
            if (original.MaxDestroyLevel <= 0) {
                ...
                Destroy(GameObject, UnityEngine.Random.Range(2, 6));
            }
        }
    }
}